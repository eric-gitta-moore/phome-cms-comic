...
<form name="paytofenform" id="payform" action="<?=$public_r['newsurl']?>e/newpay/index.php" method="post" target="_blank">
    <ul class="clf"><?=$pays?></ul>
    <div class="paybtnBOX clf">
    <p><font class="red">收款方均为个人账户 请放心付款 支付成功自动充值</font></p>
	<p><font class="red">有疑问请联系客服QQ:790043181</font></p>
	...
	<input type="hidden" name="pay_productname" value="<?=$user[username]?>_butantou" >
