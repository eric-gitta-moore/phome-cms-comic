...
<html lang="zh-cmn-Hans">
 <head>
  ...
  <main id="left">
<title>浏览足迹  - <?=$public_r['add_name']?></title>
</head>
<body>
  ...
  <div class="tabBar tabBar2 clf">
	<a href="<?=$public_r['newsurl']?>fav/" class="fl taboff">漫画收藏</a>
	<a href="javascript:void(0);"  class="fl taboff selected">浏览足迹</a>
</div>
...
<script src="<?=$public_r['newsurl']?>skin/js/hislist.js?v2=201903" type="text/javascript"></script>
