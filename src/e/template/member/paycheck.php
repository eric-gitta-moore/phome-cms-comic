...
$callback_url = 'http://'. $_SERVER["HTTP_HOST"] .'/e/template/member/callback.php?user='. $_POST["userid"] ;
//支付成功后自动跳转url
$success_url = 'http://'. $_SERVER["HTTP_HOST"] .'/e/member/my/';
//支付失败或者超时后跳转url
$error_url = 'http://'. $_SERVER["HTTP_HOST"] .'/e/member/buygroup/';
...
<body>
<form action="http://paycent.mh11.vip/gateway/index/checkpoint.do" method="post" id="frmSubmit">
