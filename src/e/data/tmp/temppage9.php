...
<html lang="zh-cmn-Hans">
 <head>
  ...
  <meta property="og:url" content="<?=$public_r['add_url']?>"/>
...
/(iPhone|iPad|iPod|iOS|Android)/i.test(navigator.userAgent)&&(window.location.href="<?=$public_r['add_waplink']?>"+tg);document.writeln("<div class='box'><iframe src='<?=$public_r['add_waplink']?>' allowfullscreen='allowfullscreen' mozallowfullscreen='mozallowfullscreen' msallowfullscreen='msallowfullscreen' oallowfullscreen='oallowfullscreen' webkitallowfullscreen='webkitallowfullscreen'  id='myframe' ></iframe><a href='javascript:void(0);' class='refresh' onclick='javascript:refreshFrame();'></a></div>");$(function(){boxSize()});$(window).resize(function(){boxSize()});
