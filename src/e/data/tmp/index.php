...
<html lang="zh-cmn-Hans">
 <head>
  ...
  <meta property="og:url" content="<?=$public_r['add_url']?>/index.php"/>
...
<div id="headerbox">
	<div id="headerbox">
		<a href="<?=$public_r['add_waplink']?>" class="logo" id="waplink"></a>
	<a href="javascript:void(0);" class="logo" id="applink"></a>
			<div class="tabBtn"><span>
	<a href="<?=$public_r['add_waplink']?>" class="on" id="waplink">首页</a>
...
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('comic',5,18,1,'age=18 and firsttitle=1 and titleimg!=""');
if($ecms_bq_sql){
...
<section class="block" style="padding:10px 0;">
	<ul class="btnList clf">
		<li><a href="<?=$public_r['newsurl'].$class_r[1]['classpath']?>/?status=end" class="bg03"></a>完本</li>
		<li><a href="<?=$public_r['newsurl'].$class_r[1]['classpath']?>/?status=even" class="bg01"></a>连载</li>
...
<div class="clearfix"></div>
  <section class="block">
    ...
    <div><ul class="book_list03 clf"><? @sys_GetEcmsInfo('comic',4,0,0,18,2,1,"isgood=1 and age=18 and cover!=''","diggtop DESC");?>
	</ul></div>
...
<div class="clearfix"></div>
    ...
    <div><ul class="book_list01 clf"><? @sys_GetEcmsInfo("comic",9,0,0,18,3,1,"ticai='|61|' and age=18 and cover!=''","diggtop DESC");?></ul></div>
    <a href="/cate/?type=61" class="morebtn">查看更多</a>
  </section>
  <div class="clearfix"></div>
  <section class="block">
    <div class="titleBar clf"><i class="fl">日韩漫画</i></div>
    <div><ul class="book_list01 clf"><? @sys_GetEcmsInfo("comic",9,0,0,18,3,1,"ticai='|62|' and age=18","diggtop DESC");?></ul></div>
    <a href="/cate/?type=62" class="morebtn">查看更多</a>
  </section>
  <div class="clearfix"></div>
  <section class="block">
    <div class="titleBar clf"><i class="fl">校园</i></div>
    <div><ul class="book_list01 clf"><? @sys_GetEcmsInfo("comic",6,0,0,18,3,1,"ticai like '%|63|%' and age=18","diggtop DESC");?></ul></div>
    <a href="/cate/?type=63" class="morebtn">查看更多</a>
  </section>
  <div class="clearfix"></div>
  <section class="block">
    <div class="titleBar clf"><i class="fl">热门追更</i></div>
    <div><ul class="book_list01 clf"><? @sys_GetEcmsInfo("comic",6,0,0,18,3,1,"ticai like '%|64|%' and age=18","diggtop DESC");?></ul></div>
    <a href="/hot/" class="morebtn">查看更多</a>
  </section>
  <div class="clearfix"></div>
  <section class="block">
    <div class="titleBar clf"><i class="fl">新番发布</i></div>
    <div><ul class="book_list01 clf"><? @sys_GetEcmsInfo("comic",3,0,0,18,3,1,"age=18","diggtop DESC");?></ul></div>
...
<section class="block">
  ...
  <ul class="book_list" id="novelList"><? @sys_GetEcmsInfo("comic",10,0,0,18,5,1,"age=18","diggtop DESC");?></ul>
