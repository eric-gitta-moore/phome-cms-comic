...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>昵称</td><td bgcolor='ffffff'><input name="truename" type="text" id="truename" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($addr[truename]))?>">
...
<?=empty($addr[userpic])?"":"<img src='".ehtmlspecialchars(stripSlashes($addr[userpic]))."' border=0>"?></td></tr></table>