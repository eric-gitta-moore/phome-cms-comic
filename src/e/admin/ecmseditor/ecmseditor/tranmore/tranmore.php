...
if($type==1)//图片
{
	$swffiletypes='*.jpg;*.gif;*.png;*.bmp;*.jpeg';
...
<script type="text/javascript" src="js/handlers.php?hnv=<?=urlencode($ecms_hashur['whehref'])?>"></script>
...
function TranMorePageAddCs(){
	...
	{
	?>
	addcs+="&bpicwidth="+document.tranmoreform.bpicwidth.value+"&bpicheight="+document.tranmoreform.bpicheight.value+"&picexp="+document.tranmoreform.picexp.value+"&picalign="+document.tranmoreform.picalign.value;
	<?php
	}
	else
	{
