...
/***替换变量***/
$_POST['titlepic'] = str_replace(array("<img src=", ">"), array("", ""), $_POST['titlepic']);
$_POST['titleimg'] = str_replace(array("<img src=", ">"), array("", ""), $_POST['titleimg']);
$_POST['back'] = str_replace(array("<img src=", ">"), array("", ""), $_POST['back']);
$_POST['cover'] = str_replace(array("<img src=", ">"), array("", ""), $_POST['cover']);
$_POST['morepic'] = str_replace(array("<img src=", ">"), array("", ""), $_POST['morepic']);
...
if ($num=='预告篇' || $num=='預告篇') {
    $_POST['num'] = '0';
}else if ($num=='后记' || $num=='後記') {
    $_POST['num'] = '999';
}else {
    $_POST['num'] = $_POST['num'];
}
if ($price == '预告篇' || $price == '預告篇' || $num=='预告篇' || $num=='預告篇' || $num=='1' || $num=='2') {
    $_POST['price'] = '1';
}else {
    $_POST['price'] = '2';
}
...
if ($typeid == 2) {
    ...
    $tr = $empire->fetch1("select id from {$dbtbpre}ecms_comic where title='{$title}'");
    if ($tr['id']) {
        echo "标题重复,增加不成功!";
    } else {
        AddNews($_POST, $logininid, $loginin);
